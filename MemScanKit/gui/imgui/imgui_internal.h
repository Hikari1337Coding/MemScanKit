...
struct IMGUI_API ImGuiWindow
{
    ...
    float                   DecoOuterSizeX1, DecoOuterSizeY1;   // Left/Up offset. Sum of non-scrolling outer decorations (X1 generally == 0.0f. Y1 generally = TitleBarHeight + MenuBarHeight). Locked during Begin().
    float                   DecoOuterSizeX2, DecoOuterSizeY2;   // Right/Down offset (X2 generally == ScrollbarSize.x, Y2 == ScrollbarSizes.y).
    ...
    int                     SettingsOffset;                     // Offset into SettingsWindows[] (offset are always valid as we only grow the array from the back)
